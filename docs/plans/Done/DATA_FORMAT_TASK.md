...
For every important data-format claim in `docs/notes/DATA_FORMAT.md`, include its evidence source.
...
1. Confirm that `docs/notes/DATA_FORMAT.md` has been created.
...
* [ ] docs/notes/DATA_FORMAT.md was created or updated.

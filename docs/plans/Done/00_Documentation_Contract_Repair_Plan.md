...
```text
docs/notes/PROJECT_REPORT.md  (Deferred / Out of Scope)
docs/notes/VENDOR_WINDOWING_REPORT.md  (Deferred / Out of Scope)
docs/notes/DATA_FORMAT.md
```
...
The following changes are intentionally excluded from this plan:

* Do not update `docs/notes/PROJECT_REPORT.md`.
* Do not treat inconsistencies in this document as blockers for the current plan.
* Revisit this document in a separate documentation task if needed.
...
* `PROJECT_REPORT.md` and `VENDOR_WINDOWING_REPORT.md` remain unmodified and
  do not block this plan; their repair is deferred to a separate task.
...
19. `PROJECT_REPORT.md` and `VENDOR_WINDOWING_REPORT.md` are deferred/out of scope.

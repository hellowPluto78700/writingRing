...
- `README.md`, `docs/notes/DATA_FORMAT.md`, and `docs/notes/PROJECT_REPORT.md`.
...
`docs/notes/PROJECT_REPORT.md`, `docs/notes/DATA_FORMAT.md`, and the relevant upstream
Ring implementation:
...
- `docs/notes/DATA_FORMAT.md` only to distinguish raw fields from the new derived
  fields—do not present the derived result as part of the file format;
- `docs/notes/PROJECT_REPORT.md` with the module/API, transformations, diagnostics,

#!/usr/bin/env bash
#SBATCH --job-name=wr-gyro02-final
#SBATCH --partition=cpu
#SBATCH --cpus-per-task=1
#SBATCH --mem=6G
#SBATCH --time=00:30:00
#SBATCH --output=unity_withgyro_exp02_finalize_%j.out
#SBATCH --error=unity_withgyro_exp02_finalize_%j.err
...
printf '[withGyro exp0.2 finalizer] conda=%s python=%s\n' \
...
python -u -m scripts.with_gyro_experiment_0_2_nonlinear_temporal_decoder_probe finalize

#!/usr/bin/env bash
#SBATCH --job-name=exp4_4_1
#SBATCH --array=0-49%50
#SBATCH --cpus-per-task=1
#SBATCH --mem=10G
#SBATCH --time=12:00:00
#SBATCH --output=exp4_4_1_%A_%a.out
#SBATCH --error=exp4_4_1_%A_%a.err
...
python -u -m scripts.experiment_4_4_1_stage2_memory_sweep run-one \

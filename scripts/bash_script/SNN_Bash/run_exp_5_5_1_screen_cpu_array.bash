#!/usr/bin/env bash
#SBATCH --job-name=exp5_5_1_screen
#SBATCH --array=0-14%15
#SBATCH --cpus-per-task=1
#SBATCH --mem=12G
#SBATCH --time=24:00:00
#SBATCH --output=exp5_5_1_screen_%A_%a.out
#SBATCH --error=exp5_5_1_screen_%A_%a.err
...
python -u -m scripts.experiment_5_5_1_regularized_semantic_when \
  screen-one \

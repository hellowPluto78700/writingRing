#!/usr/bin/env bash
#SBATCH --job-name=exp5_4_1_res
#SBATCH --array=0-4%5
#SBATCH --cpus-per-task=1
#SBATCH --mem=12G
#SBATCH --time=24:00:00
#SBATCH --output=exp5_4_1_res_%A_%a.out
#SBATCH --error=exp5_4_1_res_%A_%a.err
...
python -u -m scripts.experiment_5_4_1_constrained_conjunction_residual run-one \

#!/usr/bin/env bash
#SBATCH --job-name=exp7_2_6_4_A
#SBATCH --array=0-2%3
#SBATCH --cpus-per-task=1
#SBATCH --mem=8G
#SBATCH --time=08:00:00
#SBATCH --output=exp7_2_6_4_A_%A_%a.out
#SBATCH --error=exp7_2_6_4_A_%A_%a.err
...
python -u -m scripts.experiment_7_2_6_4_output_interface_decomposition \
  --device cpu --threads 1 part-a --array-task-id "${SLURM_ARRAY_TASK_ID:?}"

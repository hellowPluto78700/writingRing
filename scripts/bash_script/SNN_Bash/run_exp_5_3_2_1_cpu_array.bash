#!/usr/bin/env bash
#SBATCH --job-name=exp5_3_2_1_when
#SBATCH --array=0-24%25
#SBATCH --cpus-per-task=1
#SBATCH --mem=12G
#SBATCH --time=18:00:00
#SBATCH --output=exp5_3_2_1_when_%A_%a.out
#SBATCH --error=exp5_3_2_1_when_%A_%a.err
...
python -u -m scripts.experiment_5_3_2_1_when_objective_sweep run-one \

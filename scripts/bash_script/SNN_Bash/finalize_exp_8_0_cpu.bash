#!/usr/bin/env bash
#SBATCH --job-name=exp8_0_fin
#SBATCH --cpus-per-task=1
#SBATCH --mem=8G
#SBATCH --time=02:00:00
#SBATCH --output=exp8_0_finalize_%j.out
#SBATCH --error=exp8_0_finalize_%j.err
...
python -u -m scripts.experiment_8_0_local_backbone_tau_sweep \

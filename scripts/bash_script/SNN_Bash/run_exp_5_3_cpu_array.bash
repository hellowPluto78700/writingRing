#!/usr/bin/env bash
#SBATCH --job-name=exp5_3_context
#SBATCH --array=0-54%50
#SBATCH --cpus-per-task=1
#SBATCH --mem=12G
#SBATCH --time=16:00:00
#SBATCH --output=exp5_3_context_%A_%a.out
#SBATCH --error=exp5_3_context_%A_%a.err
...
python -u -m scripts.experiment_5_3_synaptic_contextual_evidence run-one \

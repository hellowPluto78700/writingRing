#!/usr/bin/env bash
#SBATCH --job-name=exp5_3_2_2_prep
#SBATCH --array=0-4%5
#SBATCH --cpus-per-task=1
#SBATCH --mem=12G
#SBATCH --time=02:00:00
#SBATCH --output=exp5_3_2_2_prep_%A_%a.out
#SBATCH --error=exp5_3_2_2_prep_%A_%a.err
...
python -u -m scripts.experiment_5_3_2_2_when_width_sweep prepare-local \

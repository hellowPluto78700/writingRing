#!/usr/bin/env bash
#SBATCH --job-name=exp7_3_e2e
#SBATCH --array=0-11%12
#SBATCH --cpus-per-task=1
#SBATCH --mem=14G
#SBATCH --time=30:00:00
#SBATCH --output=exp7_3_e2e_%A_%a.out
#SBATCH --error=exp7_3_e2e_%A_%a.err
...
python -u -m scripts.experiment_7_3_training_strategy_decomposition \
  --device cpu --threads 1 e2e --array-task-id "${SLURM_ARRAY_TASK_ID:?}"

#!/usr/bin/env bash
#SBATCH --job-name=exp7_2_6_heads
#SBATCH --array=0-11%12
#SBATCH --cpus-per-task=1
#SBATCH --mem=12G
#SBATCH --time=24:00:00
#SBATCH --output=exp7_2_6_heads_%A_%a.out
#SBATCH --error=exp7_2_6_heads_%A_%a.err
...
python -u -m scripts.experiment_7_2_6_output_readout_loss_shaping \
  --device cpu --threads 1 run-frozen-head --array-task-id "$TASK_ID"

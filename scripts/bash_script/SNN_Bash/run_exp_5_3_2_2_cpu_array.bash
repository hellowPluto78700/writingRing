#!/usr/bin/env bash
#SBATCH --job-name=exp5_3_2_2_when
#SBATCH --array=0-24%25
#SBATCH --cpus-per-task=1
#SBATCH --mem=16G
#SBATCH --time=24:00:00
#SBATCH --output=exp5_3_2_2_when_%A_%a.out
#SBATCH --error=exp5_3_2_2_when_%A_%a.err
...
python -u -m scripts.experiment_5_3_2_2_when_width_sweep run-one \

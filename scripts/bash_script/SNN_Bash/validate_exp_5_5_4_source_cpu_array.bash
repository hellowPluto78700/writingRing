#!/usr/bin/env bash
#SBATCH --job-name=exp5_5_4_source
#SBATCH --array=0-4%5
#SBATCH --cpus-per-task=1
#SBATCH --mem=16G
#SBATCH --time=04:00:00
#SBATCH --output=exp5_5_4_source_%A_%a.out
#SBATCH --error=exp5_5_4_source_%A_%a.err
...
python -u -m scripts.experiment_5_5_4_causal_when_phase_recovery \
  validate-source \

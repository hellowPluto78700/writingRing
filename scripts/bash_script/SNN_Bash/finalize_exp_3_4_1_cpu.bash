#!/usr/bin/env bash
#SBATCH --job-name=wr341-final
#SBATCH --partition=cpu
#SBATCH --cpus-per-task=1
#SBATCH --mem=4G
#SBATCH --time=01:00:00
#SBATCH --output=unity_exp341_finalize_%j.out
#SBATCH --error=unity_exp341_finalize_%j.err
...
python -u -m scripts.experiment_3_4_1_raw_causal_temporal_readout finalize

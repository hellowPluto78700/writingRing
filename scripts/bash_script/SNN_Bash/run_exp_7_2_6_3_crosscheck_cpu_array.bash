#!/usr/bin/env bash
#SBATCH --job-name=exp7_2_6_3_cross
#SBATCH --array=0-2%3
#SBATCH --cpus-per-task=1
#SBATCH --mem=8G
#SBATCH --time=08:00:00
#SBATCH --output=exp7_2_6_3_cross_%A_%a.out
#SBATCH --error=exp7_2_6_3_cross_%A_%a.err
...
python -u -m scripts.experiment_7_2_6_3_linear_vs_lif_frozen_l2 \
  --device cpu --threads 1 crosscheck --array-task-id "${SLURM_ARRAY_TASK_ID:?}"

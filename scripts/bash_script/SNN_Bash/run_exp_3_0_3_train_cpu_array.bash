#!/usr/bin/env bash
#SBATCH --job-name=wr303-train-eval
#SBATCH --partition=cpu
#SBATCH --array=0-35%50
#SBATCH --cpus-per-task=1
#SBATCH --mem=6G
#SBATCH --time=06:00:00
#SBATCH --output=unity_exp303_train_eval_%A_%a.out
#SBATCH --error=unity_exp303_train_eval_%A_%a.err
...
python -u scripts/experiment_3_0_3/01_train_one_run.py \

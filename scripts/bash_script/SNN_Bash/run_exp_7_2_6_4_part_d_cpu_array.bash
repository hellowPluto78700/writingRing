#!/usr/bin/env bash
#SBATCH --job-name=exp7_2_6_4_D
#SBATCH --array=0-26%12
#SBATCH --cpus-per-task=1
#SBATCH --mem=12G
#SBATCH --time=24:00:00
#SBATCH --output=exp7_2_6_4_D_%A_%a.out
#SBATCH --error=exp7_2_6_4_D_%A_%a.err
...
python -u -m scripts.experiment_7_2_6_4_output_interface_decomposition \
  --device cpu --threads 1 part-d --array-task-id "${SLURM_ARRAY_TASK_ID:?}"

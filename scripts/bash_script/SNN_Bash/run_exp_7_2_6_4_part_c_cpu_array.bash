#!/usr/bin/env bash
#SBATCH --job-name=exp7_2_6_4_C
#SBATCH --array=0-8%9
#SBATCH --cpus-per-task=1
#SBATCH --mem=12G
#SBATCH --time=24:00:00
#SBATCH --output=exp7_2_6_4_C_%A_%a.out
#SBATCH --error=exp7_2_6_4_C_%A_%a.err
...
python -u -m scripts.experiment_7_2_6_4_output_interface_decomposition \
  --device cpu --threads 1 part-c --array-task-id "${SLURM_ARRAY_TASK_ID:?}"

#!/usr/bin/env bash
#SBATCH --job-name=exp5_1_probe
#SBATCH --array=0-5%6
#SBATCH --cpus-per-task=1
#SBATCH --mem=8G
#SBATCH --time=04:00:00
#SBATCH --output=exp5_1_probe_%A_%a.out
#SBATCH --error=exp5_1_probe_%A_%a.err
...
python -u -m scripts.experiment_5_1_boundary_free_temporal_decoder probe-interface \

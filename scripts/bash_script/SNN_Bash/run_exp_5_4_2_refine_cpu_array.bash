#!/usr/bin/env bash
#SBATCH --job-name=exp5_4_2_ref
#SBATCH --cpus-per-task=1
#SBATCH --mem=12G
#SBATCH --time=24:00:00
#SBATCH --output=exp5_4_2_ref_%A_%a.out
#SBATCH --error=exp5_4_2_ref_%A_%a.err
...
python -u -m scripts.experiment_5_4_2_phase_conditioned_readout refine-run-one \

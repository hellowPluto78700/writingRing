#!/usr/bin/env bash
#SBATCH --job-name=exp5_4_fusion
#SBATCH --array=0-29%30
#SBATCH --cpus-per-task=1
#SBATCH --mem=16G
#SBATCH --time=24:00:00
#SBATCH --output=exp5_4_fusion_%A_%a.out
#SBATCH --error=exp5_4_fusion_%A_%a.err
...
python -u -m scripts.experiment_5_4_snn_native_fusion run-one \

#!/usr/bin/env bash
#SBATCH --job-name=wr307-final
#SBATCH --partition=cpu
#SBATCH --cpus-per-task=1
#SBATCH --mem=4G
#SBATCH --time=01:00:00
#SBATCH --output=unity_exp307_finalize_%j.out
#SBATCH --error=unity_exp307_finalize_%j.err
...
python -u scripts/experiment_3_0_7_online_early_decision.py finalize

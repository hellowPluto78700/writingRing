#!/usr/bin/env bash
#SBATCH --job-name=exp4_0_5
#SBATCH --array=0-44%45
#SBATCH --cpus-per-task=1
#SBATCH --mem=12G
#SBATCH --time=12:00:00
#SBATCH --output=exp4_0_5_%A_%a.out
#SBATCH --error=exp4_0_5_%A_%a.err
...
python -u -m scripts.experiment_4_0_5_temporal_resolution_event_capacity \
    run-one \

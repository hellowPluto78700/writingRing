#!/usr/bin/env bash
#SBATCH --job-name=exp7_2_6_3_fin
#SBATCH --cpus-per-task=1
#SBATCH --mem=4G
#SBATCH --time=02:00:00
#SBATCH --output=exp7_2_6_3_fin_%j.out
#SBATCH --error=exp7_2_6_3_fin_%j.err
...
python -u -m scripts.experiment_7_2_6_3_linear_vs_lif_frozen_l2 --device cpu --threads 1 finalize

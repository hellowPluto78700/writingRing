#!/usr/bin/env bash
#SBATCH --job-name=exp5_4_2_src
#SBATCH --array=0-4%5
#SBATCH --cpus-per-task=1
#SBATCH --mem=16G
#SBATCH --time=24:00:00
#SBATCH --output=exp5_4_2_src_%A_%a.out
#SBATCH --error=exp5_4_2_src_%A_%a.err
...
python -u -m scripts.experiment_5_4_2_phase_conditioned_readout prepare-source \

#!/usr/bin/env bash
#SBATCH --job-name=exp5_5_runs
#SBATCH --array=0-24%25
#SBATCH --cpus-per-task=1
#SBATCH --mem=12G
#SBATCH --time=24:00:00
#SBATCH --output=exp5_5_run_%A_%a.out
#SBATCH --error=exp5_5_run_%A_%a.err
...
python -u -m scripts.experiment_5_5_non_snn_history_experts \
  run-one \

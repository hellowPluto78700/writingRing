#!/usr/bin/env bash
#SBATCH --job-name=exp7_3_1_c2
#SBATCH --partition=cpu
#SBATCH --array=0-11%12
#SBATCH --cpus-per-task=1
#SBATCH --mem=8G
#SBATCH --time=02:00:00
#SBATCH --output=logs/exp7_3_1_c2_%A_%a.out
#SBATCH --error=logs/exp7_3_1_c2_%A_%a.err
...
python -m scripts.experiment_7_3_1_frozen_l2_linear_optimization \
  ...
  lbfgs-noreg --array-task-id "$SLURM_ARRAY_TASK_ID"

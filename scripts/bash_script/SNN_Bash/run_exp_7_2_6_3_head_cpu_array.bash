#!/usr/bin/env bash
#SBATCH --job-name=exp7_2_6_3_head
#SBATCH --array=0-5%6
#SBATCH --cpus-per-task=1
#SBATCH --mem=12G
#SBATCH --time=24:00:00
#SBATCH --output=exp7_2_6_3_head_%A_%a.out
#SBATCH --error=exp7_2_6_3_head_%A_%a.err
...
python -u -m scripts.experiment_7_2_6_3_linear_vs_lif_frozen_l2 \
  --device cpu --threads 1 train-head --array-task-id "${SLURM_ARRAY_TASK_ID:?}"

#!/usr/bin/env bash
#SBATCH --job-name=exp7_3_stage2
#SBATCH --array=0-23%24
#SBATCH --cpus-per-task=1
#SBATCH --mem=12G
#SBATCH --time=24:00:00
#SBATCH --output=exp7_3_stage2_%A_%a.out
#SBATCH --error=exp7_3_stage2_%A_%a.err
...
python -u -m scripts.experiment_7_3_training_strategy_decomposition \
  --device cpu --threads 1 stage2 --array-task-id "${SLURM_ARRAY_TASK_ID:?}"

#!/usr/bin/env bash
#SBATCH --job-name=exp5_1_dec
#SBATCH --array=0-47%48
#SBATCH --cpus-per-task=1
#SBATCH --mem=10G
#SBATCH --time=12:00:00
#SBATCH --output=exp5_1_dec_%A_%a.out
#SBATCH --error=exp5_1_dec_%A_%a.err
...
python -u -m scripts.experiment_5_1_boundary_free_temporal_decoder run-one \

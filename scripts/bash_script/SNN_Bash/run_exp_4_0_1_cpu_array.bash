#!/usr/bin/env bash
#SBATCH --job-name=exp4_0_1
#SBATCH --array=0-39%40
#SBATCH --cpus-per-task=1
#SBATCH --mem=8G
#SBATCH --time=06:00:00
#SBATCH --output=exp4_0_1_%A_%a.out
#SBATCH --error=exp4_0_1_%A_%a.err
...
python -u -m scripts.experiment_4_0_1_multispike_macro_lif run-one \

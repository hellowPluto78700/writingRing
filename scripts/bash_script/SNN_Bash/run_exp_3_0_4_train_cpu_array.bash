#!/usr/bin/env bash
#SBATCH --job-name=wr304-train-eval
#SBATCH --partition=cpu
#SBATCH --array=0-26%50
#SBATCH --cpus-per-task=1
#SBATCH --mem=8G
#SBATCH --time=08:00:00
#SBATCH --output=unity_exp304_train_eval_%A_%a.out
#SBATCH --error=unity_exp304_train_eval_%A_%a.err

set -euo pipefail

TASK_ID="${SLURM_ARRAY_TASK_ID:?SLURM_ARRAY_TASK_ID is required}"
if (( TASK_ID < 0 || TASK_ID >= 27 )); then
...
python -u scripts/experiment_3_0_4/01_train_one_run.py \

#!/usr/bin/env bash
#SBATCH --job-name=exp5_5_1_1_diag
#SBATCH --array=0-4%5
#SBATCH --cpus-per-task=1
#SBATCH --mem=12G
#SBATCH --time=04:00:00
#SBATCH --output=exp5_5_1_1_diag_%A_%a.out
#SBATCH --error=exp5_5_1_1_diag_%A_%a.err
...
python -u -m scripts.experiment_5_5_1_1_routing_diagnostics \
  run-seed \

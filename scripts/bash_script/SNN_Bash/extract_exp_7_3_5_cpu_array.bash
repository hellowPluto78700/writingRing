#!/usr/bin/env bash
#SBATCH --job-name=exp7_3_5_extract
#SBATCH --partition=cpu
#SBATCH --array=0-2%3
#SBATCH --cpus-per-task=1
#SBATCH --mem=12G
#SBATCH --time=03:00:00
#SBATCH --output=logs/exp7_3_5_extract_%A_%a.out
#SBATCH --error=logs/exp7_3_5_extract_%A_%a.err
...
python -m scripts.experiment_7_3_5_hidden_state_information_loss \
  ...
  extract --array-task-id "$SLURM_ARRAY_TASK_ID"

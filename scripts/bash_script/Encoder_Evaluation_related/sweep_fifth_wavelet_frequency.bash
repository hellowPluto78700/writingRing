...
ACTION0_SOURCE_COMBINATION_ROOT="${ACTION0_SOURCE_COMBINATION_ROOT:-outputs/action0_default_wavelets/low-pass/aligned-board-events}"
ACTION1_SOURCE_COMBINATION_ROOT="${ACTION1_SOURCE_COMBINATION_ROOT:-outputs/action1_default_wavelets/low-pass/aligned-board-events}"

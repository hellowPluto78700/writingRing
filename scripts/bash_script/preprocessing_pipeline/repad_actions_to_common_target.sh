...
ACTION0_ROOT="${1:-outputs/action0_wavelets_0e5_1_2_4_8/low-pass/aligned-board-events}"
ACTION1_ROOT="${2:-outputs/action1_wavelets_0e5_1_2_4_8/low-pass/aligned-board-events}"

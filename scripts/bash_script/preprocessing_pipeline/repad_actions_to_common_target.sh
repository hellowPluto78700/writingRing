...
ACTION0_ROOT="${1:-outputs/action0_default_wavelets/low-pass/aligned-board-events}"
ACTION1_ROOT="${2:-outputs/action1_default_wavelets/low-pass/aligned-board-events}"

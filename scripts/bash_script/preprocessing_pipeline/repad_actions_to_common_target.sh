...
ACTION0_ROOT="${1:-outputs/action0_rectified_new_wavelets/low-pass/aligned-board-events}"
ACTION1_ROOT="${2:-outputs/action1_rectified_new_wavelets/low-pass/aligned-board-events}"

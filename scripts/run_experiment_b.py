...
def run_experiment_b(
    *,
    ...
    checkpoint_seed = checkpoint_random_seed(
        checkpoint,
...
def main() -> None:
    ...
    baseline_path = _resolve_path(args.baseline_checkpoint, repository_root)
    baseline_checkpoint = load_checkpoint(baseline_path, map_location="cpu")
    checkpoint_seed = checkpoint_random_seed(
        baseline_checkpoint,
        source=baseline_path,
    )
    random_seed = checkpoint_seed if args.seed is None else args.seed

...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train and immediately evaluate one Experiment 3.0.3 run."
    )
...
def main() -> None:
    ...
    print("Architecture:", architecture, spec.label, spec.description)
    ...
    print(
        ...
        f"last_layer={evaluation['last_layer']}",
